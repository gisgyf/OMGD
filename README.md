...
### scale_detector(path_list: Sequence, Y, factors:Sequence, disc_interval:Sequence, type_factors:Sequence=[], quantile:float=0.8, n_variates=1, random_state=0)
...
### omgd(df:pd.DataFrame, Y, factors:Sequence, n_variates:int, disc_interval:Sequence, type_factors:Sequence=[], random_state=0)
...
### omgd.factor_detector(df, Y, factors:Sequence)
### omgd.interation_detector(df:pd.DataFrame, Y, factors:Sequence)
### omgd.risk_detector(df, Y, factors:Sequence)
### omgd.ecological_detector(df, Y, factors:Sequence)
...
### classify(X, n_clusters, classify_result, colname, random_state=0)
